...
public class DematAccount extends SavingsAccount {
	//These state variables can only be accessed in this class as they are private
	//Hence, the state is encapsulated in DematAccount object
	private int dematID;
	private int stockAmount; // can only be accessed via displayAccountDetails and investStocks functions
